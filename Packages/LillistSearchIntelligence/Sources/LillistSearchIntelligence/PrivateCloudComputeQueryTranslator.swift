...
/// even compile (see the "Issue #51" entry in `docs/engineering-notes.md`);
/// `FilterTranslatorFactory` only constructs this type once it has already
/// confirmed `#available(iOS 27, macOS 27, *)` and that the model reports
/// itself available, and falls back to `OnDeviceQueryTranslator` otherwise.
