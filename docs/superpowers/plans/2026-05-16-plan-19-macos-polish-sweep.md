...
- **Plan 17** (i18n/a11y environments) — Task 25 of Plan 17 adds `.keyboardShortcut(.cancelAction)` to the recurrence editor's Cancel button. Do not duplicate. Task 1 here (WindowGroup title) should use `LocalizedStringKey` if Plan 17 has merged the String Catalog scaffolding.
