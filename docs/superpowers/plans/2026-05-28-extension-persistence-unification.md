...
> **📍 STATUS — ✅ COMPLETE — merged to `main` (Wave 6, FIRST plan; commits `d38134d`..`3ffa0e0` + `cf75e87`..`5dcaab1`).** Closed ext-1…6 + residual #10. Note: `5dcaab1` additionally fixed a residual-#11 iOS-bundle crash the per-process cache exposed (`IntentSupportGateTests` no longer builds a live CloudKit container). A post-wave adversarial review hardened the cache (`2723769`, concurrent-cold-build coalescing). See `docs/superpowers/handoffs/wave-6.md`.
>
